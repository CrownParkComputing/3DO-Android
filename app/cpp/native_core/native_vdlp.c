#include "native_backend_flags.h"
#include "native_backend_hack_flags.h"
#include "native_backend_inline.h"

#include "native_backend_boolean.h"

#include "native_backend_arm.h"
#include "native_backend_core.h"
#include "native_backend_mem.h"
#include "native_backend_region.h"
#include "native_backend_state.h"
#include "native_backend_vdl.h"
#include "native_backend_vdlp.h"
#include "native_backend_vdlp_i.h"
...
/*
  ...
  The addresses shouldn't be outside the RAM space but are at times.
*/
static
INLINE
uint32_t
...
static
void
vdlp_render_line_0RGB1555_hires_bypass_clut(void)
{
  int x;
  int width;
  uint16_t *dst0;
             ...
             uint32_t            flags_)
{
  ...
  switch(x)
    {
    case _(0RGB1555,VDLP_FLAG_NONE):
      return vdlp_render_line_0RGB1555;
    case _(0RGB1555,VDLP_FLAG_BYPASS_CLUT):
      return vdlp_render_line_0RGB1555_bypass_clut;
    case _(0RGB1555,VDLP_FLAG_HIRES_CEL):
      return vdlp_render_line_0RGB1555_hires;
    case _(0RGB1555,VDLP_FLAG_BYPASS_CLUT|VDLP_FLAG_HIRES_CEL):
