#ifndef NATIVE_BACKEND_VDLP_I_H_INCLUDED
#define NATIVE_BACKEND_VDLP_I_H_INCLUDED
...
{
  uint32_t persist_len:9;
  uint32_t ctrl_word_cnt:6;
  uint32_t prev_fba_override:1;
  uint32_t curr_fba_override:1;
  uint32_t prev_fba_tick:1;
  uint32_t next_vdl_addr_rel:1;
  uint32_t vertical_mode:1;
  uint32_t padding0:1;
  uint32_t enable_dma:1;
  uint32_t padding1:1;
  uint32_t fba_incr_modulo:3;
  uint32_t padding2:6;
};
...
struct color_value_word_s
{
  ...
  uint32_t r:8;
  uint32_t addr:5;
  uint32_t rgb_enable:2;
  uint32_t ctrl_color:1;
};
...
{
  uint32_t vi_off_1_line:1;
  uint32_t colors_only:1;
  uint32_t hi_on:1;
  uint32_t vi_on:1;
  uint32_t line_blue_lsb:2;
  uint32_t line_hsrc:2;
  uint32_t line_vsrc:2;
  uint32_t swap_pen:1;
  uint32_t msb_replication:1;
  uint32_t random:1;
  uint32_t window_hi_on:1;
  uint32_t window_vi_on:1;
  uint32_t window_blue_lsb:2;
  uint32_t window_hsrc:2;
  uint32_t window_vsrc:2;
  uint32_t swap_hv:1;
  uint32_t enable_bg_color_detector:1;
  uint32_t tran_true:1;
  uint32_t src_sel:1;
  uint32_t clut_bypass:1;
  uint32_t reserved:1;
  uint32_t pal_ntsc:1;
  uint32_t null:1;
  uint32_t ctrl_color:3;
};
